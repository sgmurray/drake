...
DifferentialInverseKinematicsResult DoDifferentialInverseKinematics(
    ...
    const DifferentialInverseKinematicsParameters& parameters) {
  const Frame<double>& frame_A = parameters.get_reference_frame() == nullptr ?
    plant.world_frame() : *parameters.get_reference_frame();
...
DifferentialInverseKinematicsResult DoDifferentialInverseKinematics(
  ...
  return DoDifferentialInverseKinematics(plant, context, V_AE_desired,
                                         frame_E, parameters);
}
